client_id = 'OlD4Z6GmBYXUpi23jSUPvCAfZQNniv0z'
client_secret = 'SGNujg2Wwa1XdeAA'
...
function searchByAirportsDate(event){
    ...
    console.log(date);
     ...
     if(departureAirport === arrivalAirport){
        ...
        hideError(""); 
        //Preparo richiesta
        //const url = 'infoVoli/aeroportoPartenza/'+departureAirport+'/aeroportoArrivo/'+arrivalAirport+'/dataPartenza/'+date;
        //const url = 'infoVoli/aeroportoPartenza/aeroportoArrivo/dataPartenza/'+departureAirport+'/'+arrivalAirport+'/'+date;
        const url = 'infoVoli/airportsDate/'+departureAirport+'/'+arrivalAirport+'/'+date;
...
function onJsonID (json){
    if(json.exists){
        ...
        console.log(json);
        console.log('Ho trovato la seguente corrispondenza: ');
        console.log('Numero di volo: ' + json.flightID + '\n');
...
function searchByID(event){
    ...
    if(flightID.length !== 4){
        ...
        hideError(""); 
        //Effettuo richiesta
        fetch("infoVoli/id/"+flightID).then(onResponseID).then(onJsonID);
    }
}
